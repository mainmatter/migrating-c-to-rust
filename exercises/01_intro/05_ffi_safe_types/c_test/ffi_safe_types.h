/* WARNING: this file was auto-generated by cheadergen from
 * `exercises/01_intro/05_ffi_safe_types`. Do not edit it manually. */
 ...
 * slicing". Note this will panic if the byte indices provided are not character
 * boundaries - see [`is_char_boundary`] for more details. See the
 ...
 * # Deref
 *
 * `String` implements <code>[Deref]<Target = [str]></code>, and so inherits all
 * of [`str`]'s methods. In addition, this means that you can pass a `String` to
 ...
 * stored in the buffer, and the capacity is the size of the buffer in bytes. As
 * such, the length will always be less than or equal to the capacity.
 *
...
struct String bm_tag_describe(struct Tag tag);
