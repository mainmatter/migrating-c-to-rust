/* WARNING: this file was auto-generated by cheadergen from `exercises/01_intro/05_ffi_safe_types`. Do not edit it manually. */
...
const struct String *bm_tag_describe(const struct Tag *tag);
